...
class Comment
{
    ...
    {
	    $metadata->addPropertyConstraint('user', new NotBlank(array('message' => 'Usted debe ingresar su nombre')));
	    $metadata->addPropertyConstraint('comment', new NotBlank(array('message' => 'Usted debe ingresar un comentario')));		
	} 	
}